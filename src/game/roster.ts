...
export const ANIMALS: AnimalDef[] = [
  {
    ...
    name: 'Pip',
    species: 'Gecko',
    perkLabel: 'Steady Grip — 25% less wobble',
    perk: { wobble: 0.75, damage: 1, armor: 1, launch: 1, blast: 1, wind: 1, zoneBonus: 0 },
    palette: { body: 0x9fbe3b, belly: 0xd2f19e, accent: 0xf3a72f, limb: 0x849c00, eye: 0xfff3c4, cloth: 0xf1b137, leather: 0x6b4a2c },
  },
  {
    id: 'frog',
    name: 'Bruno',
    species: 'Tree Frog',
    perkLabel: 'Big Splash — 20% wider blast',
    perk: { wobble: 1, damage: 1, armor: 1, launch: 1, blast: 1.2, wind: 1, zoneBonus: 0 },
    palette: { body: 0x27b2c4, belly: 0xc9f2ef, accent: 0xeb6662, limb: 0x1d8b9a, eye: 0xfae180, cloth: 0xe05f52, leather: 0x4a3524 },
  },
  {
    id: 'boar',
    name: 'Tusk',
    species: 'Wild Boar',
    perkLabel: 'Heavy Hitter — +15% damage & wobble',
    perk: { wobble: 1.15, damage: 1.15, armor: 1, launch: 1, blast: 1, wind: 1, zoneBonus: 0 },
    palette: { body: 0x8a5a3b, belly: 0xc79b73, accent: 0xf2e8d5, limb: 0x6d452c, eye: 0xfdd16c, cloth: 0x3d6ea8, leather: 0x5a3a22 },
  },
  {
    id: 'raccoon',
    name: 'Sly',
  ...
  },
  {
    ...
    name: 'Bunker',
    species: 'Tortoise',
    perkLabel: 'Shell Up — 20% tougher, slower',
    perk: { wobble: 1, damage: 1, armor: 0.8, launch: 0.94, blast: 1, wind: 1, zoneBonus: 0 },
    palette: { body: 0x9aa552, belly: 0xd7d9a8, accent: 0x6b4f28, limb: 0x7d8744, eye: 0xfff0c9, cloth: 0xce5447, leather: 0x5c4630 },
  },
  {
    id: 'toucan',
    name: 'Zip',
    species: 'Toucan',
    perkLabel: 'Wind Reader — half the wind',
    perk: { wobble: 1, damage: 1, armor: 1, launch: 1, blast: 1, wind: 0.5, zoneBonus: 0 },
    palette: { body: 0x35323a, belly: 0xfdf3dc, accent: 0xf88f39, limb: 0x24222a, eye: 0xfff6e0, cloth: 0xf4f0e4, leather: 0x45362a },
  },
];
